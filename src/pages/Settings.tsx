  ...
  return (
    <div className="flex flex-col overflow-y-auto pb-8">
      ...
      <div className="px-6 pt-5 pb-0">
        <p className="text-[rgba(255,255,255,0.85)] text-[20px] font-[700] tracking-[-0.8px]">Settings</p>
      </div>
      ...
      <div className="px-6 pt-4 pb-2 border-b border-[rgba(255,255,255,0.05)]">
        <button
          onClick={handleSaveIncome}
          disabled={!incomeValid}
          className="w-full py-3.5 rounded-2xl bg-[rgba(255,255,255,0.9)] text-[#080808] font-semibold text-sm disabled:opacity-25 disabled:cursor-not-allowed active:scale-[0.98] transition-all"
        >
      ...
      {!editingSplits ? (
        <div className="border-b border-[rgba(255,255,255,0.05)]">
          {[
            { key: 'needs' as keyof BudgetSplits, label: 'Needs', color: 'rgba(96,165,250,0.75)' },
            { key: 'wants' as keyof BudgetSplits, label: 'Wants', color: 'rgba(167,139,250,0.75)' },
        ...
        <div className="border-b border-[rgba(255,255,255,0.05)]">
          {(['needs', 'wants', 'savings'] as (keyof BudgetSplits)[]).map(key => {
            const colors: Record<keyof BudgetSplits, string> = {
              needs: 'rgba(96,165,250,0.75)',
              wants: 'rgba(167,139,250,0.75)',
              savings: 'rgba(74,222,128,0.75)',
            }
            return (
          ...
          <div className="px-6 py-3">
            {splitsError && <p className="text-[rgba(248,113,113,0.8)] text-xs mb-2">{splitsError}</p>}
            <p className={cn('text-xs mb-3', splitValid ? 'text-[rgba(74,222,128,0.7)]' : 'text-[rgba(248,113,113,0.7)]')}>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-xl bg-[rgba(255,255,255,0.9)] text-[#080808] text-sm font-semibold active:scale-[0.98] transition-all"
              >
                Save Split
              </button>
            </div>
      ...
      <div className="border-t border-[rgba(255,255,255,0.05)]">
        ...
        <button
          ...
          className={cn(
            'flex items-center gap-4 w-full px-6 py-4 border-b border-[rgba(255,255,255,0.05)] transition-colors active:scale-[0.99]',
            clearConfirm ? 'bg-[rgba(248,113,113,0.07)]' : 'active:bg-[rgba(255,255,255,0.02)]'
          )}
        >
          <div className={cn(
          ...
          <span className={cn(
            ...
            clearConfirm ? 'text-[rgba(248,113,113,0.85)]' : 'text-[rgba(255,255,255,0.65)]'
          )}>
